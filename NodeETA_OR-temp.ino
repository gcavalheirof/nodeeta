...
const char* mqtt_user = "xxxxxxxxxxxxxxxxx";
...
IPAddress local_IP(xxxxxxxxxxxxxxxxx);
IPAddress gateway(xxxxxxxxxxxxxxxxx);
IPAddress subnet(xxxxxxxxxxxxxxxxx);
...
void setup() {
  ...
  ElegantOTA.begin(&server, "xxxxx", "xxxxx");    // Start ElegantOTA
  server.begin();
